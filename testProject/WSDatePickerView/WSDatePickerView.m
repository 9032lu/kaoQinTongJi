    ...
    if (self) {
        ...
        switch (datePickerStyle) {
            ...
            case DateStyleShowMonthDay:
                _dateFormatter = @"yyyy-MM-dd";
                break;
            case DateStyleShowHourMinuteSecond:
...
-(NSArray *)getNumberOfRowsInComponent {
    ...
    switch (self.datePickerStyle) {
        ...
        case DateStyleShowMonthDay:
            ...
            break;
        case DateStyleShowHourMinuteSecond:
            return @[@(hourNum),@(minuteNUm),@(minuteNUm)];
            break;
        case DateStyleShowYear:
            return @[@(yearNum)];
            break;
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    switch (self.datePickerStyle) {
        ...
        case DateStyleShowMonthDay:
            ...
            break;
        case DateStyleShowHourMinuteSecond:
            dateStr = [NSString stringWithFormat:@"%@:%@:%@",_hourArray[hourIndex],_minuteArray[minuteIndex],_minuteArray[secondIndex]];
            break;
        case DateStyleShowYear:
...
- (void)getNowDate:(NSDate *)date animated:(BOOL)animated
{
    ...
    if (self.datePickerStyle == DateStyleShowHourMinuteSecond)
